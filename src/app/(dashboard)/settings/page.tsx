...
export default function SettingsPage() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-[50vh] flex flex-col items-center justify-center text-white animate-pulse">
        <Loader2 className="w-10 h-10 animate-spin text-indigo-500 mb-4" />
        <p className="text-slate-400">Loading your settings dashboard...</p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-10 select-none text-white">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800/80 pb-5">
        ...
        {activeTab !== "notifications" && activeTab !== "team" && (
          <button
            ...
            disabled={isSaving}
            className="flex items-center justify-center gap-1.5 bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs px-4 py-2 rounded-lg transition-colors shadow-lg shadow-indigo-600/10"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        {/* Navigation Sidebar */}
        <div className="lg:col-span-3 bg-slate-900/60 border border-slate-800 rounded-xl p-3 shadow-xl space-y-1">
          {[
            ...
            return (
              <button
                ...
                className={cn(
                  "w-full flex items-center gap-3 px-3 py-2 text-xs font-semibold rounded-lg transition-all",
                  activeTab === tab.id
        ...
        <div className="lg:col-span-9 space-y-6">
          ...
          {activeTab === "profile" && (
            <div className="space-y-6">
              <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 shadow-xl space-y-4">
                <h3 className="text-sm font-bold border-b border-slate-800 pb-3">Basic Information</h3>
              ...
              {/* Address */}
              <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 shadow-xl space-y-4">
                <h3 className="text-sm font-bold border-b border-slate-800 pb-3">Address details</h3>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        className="w-full bg-slate-950 border border-slate-800 rounded-lg h-9 px-2 text-xs text-white focus:outline-none focus:border-indigo-500"
                      >
              ...
              {/* Legal info & GSTIN */}
              <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 shadow-xl space-y-4">
                <h3 className="text-sm font-bold border-b border-slate-800 pb-3">Legal & Tax info</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    {business.gstin && business.gstin.length !== 15 && (
                      <span className="text-[10px] text-amber-500 block">Must be exactly 15 characters.</span>
                    )}
                  </div>
                  <div className="space-y-1.5">
              ...
              <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 shadow-xl space-y-4">
                <h3 className="text-sm font-bold border-b border-slate-800 pb-3">Invoice Logo</h3>
                <div className="flex flex-col sm:flex-row items-center gap-6">
                  <div className="w-24 h-24 bg-slate-950 border border-slate-800 rounded-xl flex items-center justify-center overflow-hidden">
                    {business.logo_url ? (
                  ...
                  <div className="space-y-2">
                    <span className="text-xs font-semibold block text-slate-300">Upload business logo</span>
                    <span className="text-[10px] text-slate-500 block">PNG, JPG, SVG allowed. Maximum size: 2MB.</span>
                    <label className="inline-flex items-center gap-1.5 bg-slate-800 hover:bg-slate-750 text-white text-xs font-bold px-3 py-1.5 rounded cursor-pointer transition-colors">
          ...
          {activeTab === "invoice" && (
            <div className="space-y-6">
              {/* Numbering Prefix */}
              <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 shadow-xl space-y-4">
                <h3 className="text-sm font-bold border-b border-slate-800 pb-3">Invoice Numbering</h3>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-end">
                  ...
                  <div className="bg-slate-950 p-2.5 rounded-lg border border-slate-850 flex flex-col justify-center text-center">
              ...
              <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 shadow-xl space-y-5">
                <h3 className="text-sm font-bold border-b border-slate-800 pb-3">Invoice Layout & Customization</h3>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      {[
                        ...
                        <button
                          ...
                          className={cn(
                            "p-3 rounded-lg border text-left space-y-1.5 transition-all bg-slate-950/20",
                            business.invoice_template === t.id
                              ? "border-indigo-500 ring-2 ring-indigo-500/10 bg-slate-950/60"
                              : "border-slate-800 hover:border-slate-700"
                          )}
                        >
                          <span className="text-xs font-bold block">{t.title}</span>
                          <span className="text-[10px] text-slate-500 leading-normal block">{t.desc}</span>
                        </button>
                      ))}
                    </div>
                  </div>
                        ...
                        {[
                          ...
                          <button
                            ...
                            className={cn(
                              ...
                              c.hex,
                              business.primary_color === c.id ? "ring-2 ring-white ring-offset-2 ring-offset-slate-955" : "hover:scale-110"
                            )}
                          />
                        ))}
                      </div>
                      ...
                      <div className="flex gap-2">
                        {["Inter", "Roboto"].map((f) => (
                          <button
                            ...
                            className={cn(
                              "px-3 py-1.5 rounded border text-xs font-semibold transition-all",
              ...
              <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 shadow-xl space-y-4">
                <h3 className="text-sm font-bold border-b border-slate-800 pb-3">Default Note templates</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
          ...
          {activeTab === "payment" && (
            <div className="space-y-6">
              {/* UPI */}
              <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 shadow-xl space-y-4">
                <h3 className="text-sm font-bold border-b border-slate-800 pb-3">UPI ID (Instants in India)</h3>
                <div className="space-y-4">
                  <div className="space-y-1.5">
                  ...
                  <div className="bg-slate-950/40 border border-slate-850 p-3 rounded-lg flex items-center justify-between gap-4">
                    <span className="text-[10px] text-slate-500 font-medium">Auto-compatible Apps:</span>
                    <span className="text-xs font-bold text-indigo-400">BHIM, Google Pay, PhonePe, Paytm</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 shadow-xl space-y-4">
                <h3 className="text-sm font-bold border-b border-slate-800 pb-3">Direct Bank Transfer</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase font-bold text-slate-500 flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="text-[9px] text-indigo-400 hover:text-white border-0 bg-transparent font-bold capitalize"
                      >
                        {showAccountNumber ? <EyeOff className="w-3 h-3 inline mr-0.5" /> : <Eye className="w-3 h-3 inline mr-0.5" />}
              ...
              <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 shadow-xl space-y-4">
                ...
                <div className="bg-slate-950 p-4 rounded-lg border border-slate-850 flex flex-col justify-center space-y-1">
                  <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider block">Credential Key ID (Active)</span>
                  <span className="text-xs font-mono font-bold text-slate-300">rzp_test_...XXXX</span>
                  <span className="text-[9px] text-slate-500 mt-2 block">To reconnect or change credentials, check your `.env.local` config files.</span>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
                  <div className="flex items-center justify-between p-3 bg-slate-950/40 rounded-lg border border-slate-850">
                    <div className="space-y-0.5">
                      <span className="text-xs font-bold block text-slate-500 line-through">WhatsApp Notifications</span>
                    ...
                    <label className="relative inline-flex items-center cursor-not-allowed opacity-50">
                      ...
                      />
                      <div className="w-9 h-5 bg-slate-950 border border-slate-850 peer-focus:outline-none rounded-full peer after:content-[''] after:absolute after:top-[4px] after:left-[4px] after:bg-slate-650 after:border-slate-500 after:border after:rounded-full after:h-3.5 after:w-3.5 after:transition-all"></div>
                    </label>
                  </div>
              ...
              <div className="border border-slate-800 bg-slate-900/60 backdrop-blur-xl rounded-xl p-5 shadow-xl text-white space-y-4">
                <div>
                  ...
                  <p className="text-[10px] text-slate-450 mt-0.5">Click a milestone type to review email message formatting.</p>
                </div>
                    ...
                    <button
                      ...
                      className={`text-[9px] font-bold px-2 py-1 rounded transition-colors ${
                        activePreview === tab.id
                          ...
                          : "bg-slate-950/60 text-slate-455 hover:bg-slate-850 hover:text-white"
                      }`}
                    >
                      {tab.label}
                    </button>
                ...
                <div className="space-y-2">
                  <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1.5">
                    <Mail className="w-3.5 h-3.5 text-sky-400" /> Email Subject Line Preview
                  </span>
          ...
          {activeTab === "team" && (
            <div className="space-y-6">
              {/* Roster Listing */}
              <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 shadow-xl space-y-4">
                <h3 className="text-sm font-bold border-b border-slate-800 pb-3">Current Team Members</h3>
                <div className="overflow-x-auto border border-slate-850 rounded-lg">
                  <table className="w-full text-left border-collapse text-xs">
                    <thead>
                      <tr className="bg-slate-950 text-[10px] text-slate-450 font-semibold border-b border-slate-850">
                    ...
                    <tbody className="divide-y divide-slate-800/40 text-slate-300">
                      <tr className="hover:bg-slate-800/5">
                        <td className="p-3 font-semibold">owner@collectbot.in (You)</td>
                        <td className="p-3 font-mono text-[10px] uppercase text-indigo-400 font-bold">Owner</td>
                        <td className="p-3">
                      ...
                      {team.map((member) => (
                        <tr key={member.id} className="hover:bg-slate-800/5">
                          <td className="p-3 font-medium">{member.email}</td>
                          <td className="p-3 font-mono text-[10px] uppercase text-slate-400">{member.role}</td>
                          <td className="p-3">
                            <span className={cn(
                              "text-[10px] font-bold",
                          ...
                          <td className="p-3 text-center">
                            <button
                              ...
                              className="text-slate-500 hover:text-rose-455 p-1 transition-colors"
                            >
              ...
              {/* Invite Member form */}
              <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 shadow-xl space-y-4">
                <h3 className="text-sm font-bold border-b border-slate-800 pb-3">Invite Team Member</h3>
                <form onSubmit={handleInviteTeamMember} className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-end">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      type="submit"
                      disabled={isSaving}
                      className="bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs h-9 px-4 rounded-lg flex items-center justify-center gap-1.5 transition-colors self-end"
                    >
